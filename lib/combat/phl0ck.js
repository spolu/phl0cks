...
var phl0ck = function(spec, my) {
  ...
  // public
  var init;     // init(spec);
  var control;  // control(step, t, ship, ships, missiles);
   ...
   *             ships controlled
   */
  init = function(size, spec) {
    my.fl0ck = require(my.path);
    my.fl0ck.init(size, spec);
  }
   ...
   * @return { theta, sigma }
   */
  control = function(step, t, ship, ships, missiles) {
    return my.fl0ck.control(step, t, ship, ships, missiles);
  }
