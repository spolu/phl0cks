...
phl0cks.commands = {
  'signup': require('./lib/command/signup.js').signup,
  'login': require('./lib/command/login.js').login,
  'logout': require('./lib/command/logout.js').logout,
  'simulate': require('./lib/command/simulate.js').simulate,
  'challenge': require('./lib/command/challenge.js').challenge
};
