...
var boilerplate = function(spec, my) {
  ...
  help = function(args, cb_) {
    ...
    my.log.help('');
    my.log.help('phl0cks boilerplate [<type>]');
    my.log.help('');
    my.log.help('Arguments:'.yellow);
    my.log.help('  type'.bold + '   type of the boilerplate template to dump (default: `dummy`)');
    my.log.help('         Available templates are: ' + 'dummy, pendulum'.grey);
    my.log.help('');
    my.log.help('Examples:'.yellow);
    my.log.help('  phl0cks boilerplate > my_phl0ck.js');
    my.log.help('  phl0cks boilerplate pendulum > test_phl0ck.js');
    my.log.help('  phl0cks boilerplate astar');
    return cb_();
  };
