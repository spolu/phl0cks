...
phl0cks.welcome = function(cb_) {
  ...
  phl0cks.log.help('');
  phl0cks.log.help('To create a pre-built phl0ck template'.cyan);
  phl0cks.log.help('  phl0cks boilerplate [<path>]');
  phl0cks.log.help('');
  phl0cks.log.help('To simulate a combat locally'.cyan);
  phl0cks.log.help('  phl0cks simulate [<size>] [<path1>] [<path2>] ...');
  phl0cks.log.help('');
  phl0cks.log.help('To manage challenges'.cyan);
  phl0cks.log.help('  phl0cks challenge new [<size>] [<path>] [<user1>] ...');
